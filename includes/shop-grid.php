...
/**
 * Loop contexts where the shop-archive grid layout applies. The product rails
 * carry their own card alignment (see product-rail.css), so this stays scoped
 * to the real shop / taxonomy / search archives.
 */
