...
?>
<section <?php echo get_block_wrapper_attributes(array('class' => 'gh-block gh-instagram-feed')); ?> data-gh-reveal="up">
    <div class="gh-section-header gh-instagram-feed__header">
        <?php if (!empty($title)) : ?>
